...
# Train CPD (conditional on rain and maintenance)
cpd_train = TabularCPD(variable='train', variable_card=2,
                        values=[[0.8, 0.9, 0.6, 0.7, 0.4, 0.5],  # on time
